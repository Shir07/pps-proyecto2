...
async function registrarEmpresa(event) {
    ...
    const repetirPassword = document.getElementById('repetir-clave').value;
    ...
    if (password !== repetirPassword) {
        mostrarModal("Error de Validación", "Las contraseñas no coinciden.", 'error');
        return;
    }
    ...
    try {
        ...
        if (response.ok) {
            ...
            mostrarModal("¡Registro Exitoso! ✅", "Tu empresa ha sido registrada correctamente. Serás redirigido al inicio de sesión.", 'éxito');
